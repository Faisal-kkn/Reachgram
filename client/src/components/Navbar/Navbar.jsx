...
function Navbar() {
    ...
    const navigation = [
        ...
        {
            name: <Link to='/chat' className="w-6 h-6" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
